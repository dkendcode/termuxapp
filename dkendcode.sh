...
echo -b "AUTHOR : dkendcode $green " |lolcat
...
echo -b $green"[#]> dkendcode On Your System" |lolcat
...
00) echo "AUTHOR: dkendcode" | lolcat

echo "dkendcode ON YOUR SYSTEM" | lolcat

figle dkendcode | lolcat
